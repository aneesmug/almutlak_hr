<?php
	...
	$getquery = mysqli_query($conDB, "SELECT * FROM `machines` WHERE `id`='".$_GET['id']."' ");
		...
		$query_mactrny = mysqli_query($conDB, "SELECT * FROM `machine_trans` WHERE `mid`='".$_GET['id']."' ORDER BY `id` DESC LIMIT 1");
           ...
           // $old_location = str_replace(' ', '-', $old_location); 
...
if(isset($_POST['submit'])){
	...
	if(
		!empty($_POST['inv_no']) && !empty($_POST['item_name']) && !empty($_POST['quantity']) && !empty($_POST['product_price']) 
	    ...
	    for ($i = 0; $i < count($item_name_array); $i++) {
	        ...
	        $item_name_po = mysqli_real_escape_string($conDB, $item_name_array[$i]);
	        $quantity_po = mysqli_real_escape_string($conDB, $quantity_array[$i]);
	        $product_price_po = mysqli_real_escape_string($conDB, $product_price_array[$i]);

			mysqli_query($conDB, "INSERT INTO `machine_inv` (`mid`, `inv_no`, `item`, `qty`, `price`, `date_reg`, `location`) VALUES ('".$_GET['id']."','".$inv_no_po."','".$item_name_po."','".$quantity_po."','".$product_price_po."','".date('c')."','".$old_location."' )");
                                        ...
                                        <div class="col-6 ">
                                            <div class="mt-3 float-left">
                                                ...
                                                <div class="input-group mb-2">
                                                    ...
                                                    <input class="form-control" type='text' id='inv_no' name='inv_no' placeholder="Enter Invoice No." required />
                                                </div>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table mt-4" id="orders">
                                                    ...
                                                    <tr><th width="60">#</th>
                                                        ...
                                                        <th width="180">Unit Cost</th>
                                                        <th width="230" class="text-right">Total</th>
                                                    ...
                                                    <tr class="set">
                                                        ...
                                                        <td>
                                                        	<input class="form-control quantity" type='number' id='quantity_1' name='quantity[]' for="1" required />
                                                        </td>
                                                        <td>
                                                        	<input class="form-control product_price" type='number' data-type="product_price" id='product_price_1' name='product_price[]' for="1" required />
                                                        </td>
                                                        <td class="text-right">
                                                        	<input class="form-control total_cost" type='text' id='total_cost_1' name='total_cost[]' for='1' readonly />
                                                        </td>
														<td class="text-right">
                                                        	<a href="javascript:void(0);" class="btn btn-success btn-sm" id="add" title="Add field"><i class="mdi mdi-database-plus"></i></a>
                                                        </td>
...
<!--                                                 <p><b>Sub-total:</b> $4120.00</p>
                                                ...
                                                <div class="input-group mb-2">
                                                    ...
                                                    <input class="form-control discount" type='text' data-type="discount" id='discount' name='discount' for="1" />
                                                ...
                                                <div class="input-group mb-2">
                                                    <div class="input-group-prepend">
                                                        <div class="input-group-text">G-Total</div>
                                                    </div>
                                                    <input class="form-control gtotal" type='text' id='gtotal' name='gtotal' readonly/>
                                                </div>
                                            	</div>
                                            <div class="clearfix"></div>
                                        </div>
