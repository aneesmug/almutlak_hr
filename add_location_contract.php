			...
			<div class="row">
				<div class="col-md-12">
					<div class="card-box">
						...
						<form action="<?=$_SERVER['PHP_SELF']; ?>" method="post" id='registration'>
							<?=$msg ?>
							<div class="form-row">
						...
						<a href="view_location.php?id=<?=$_GET['location_id'] ?>" class="btn btn-dark"><i class="fa fa-angle-double-left"></i> Back</a>
