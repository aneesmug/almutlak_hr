...
/*******************/
	mysqli_query($conDB, "UPDATE `employees` SET `fly`='no' WHERE `id`='".$_GET['id']."' AND `emp_id`='".$_GET['emp_id']."' ") or die (mysqli_error());
	if($_GET['status'] == 'not_approve'){
		mysqli_query($conDB, "UPDATE `apply_vac_dep` SET `status`='".$_GET['status']."', `hr_note`='".$_GET['hrnote']."', `gm_note`='".$_GET['note']."', `review`='C' WHERE `id`='".$_GET['id']."' AND `emp_id`='".$_GET['empidnoapp']."' ") or die (mysqli_error());
	}else{
		mysqli_query($conDB, "UPDATE `apply_vac_dep` SET `status`='".$_GET['status']."', `gm_note`='".$_GET['note']."' WHERE `id`='".$_GET['id']."' AND `review`='".$_GET['reviewnoapp']."' AND `emp_id`='".$_GET['empidnoapp']."' ") or die (mysqli_error());
	}
