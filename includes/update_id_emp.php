...
/*******************/
	$iqama_exp_up = $_GET['new_id_date'];
	
	$iqama_exp_gup = $DateConv->HijriToGregorian($iqama_exp_up, $format);
	$iqama_exp_g_up = date("Y/m/d", strtotime($iqama_exp_gup));
	
	mysqli_query($conDB, "UPDATE `employees` SET `iqama_exp`='".$_GET['new_id_date']."',`iqama_exp_g`='".$iqama_exp_g_up."' WHERE `id`='".$_GET['id']."' AND `emp_id`='".$_GET['emp_id']."' ") or die (mysqli_error());
