...
if (!function_exists('get_default_page_access_roles')) {
    ...
    function get_default_page_access_roles() {
        return [
            ...
            'import_loan_opening_balance.php' => ['Administrator', 'HR_Senior_BP', 'HR_Payroll', 'Finance_Officer', 'Auditor', 'HR_Team', 'HR_Team_Manager', 'Finance_Team', 'Finance_Team_Manager', 'HR_Manager', 'Finance_Manager'],
