...
function generatePagination($conDB, $count_query, $per_page, $page, $url_params = []){
    ...
    if ($setLastpage > 1) {
        ...
        $setPaginate .= "<li class='page-item'><span class='page-link'>".__('page')." $page ".__('of')." $setLastpage</span></li>";
        ...
        if ($page < $counter - 1) {
            $setPaginate .= "<li class='page-item'><a class='page-link' href='{$page_url}page=$next'>".__('next')."</a></li>";
            $setPaginate .= "<li class='page-item'><a class='page-link' href='{$page_url}page=$setLastpage'>".__('last')."</a></li>";
        } else {
            $setPaginate .= "<li class='page-item active'><a class='page-link'>".__('next')."</a></li>";
            $setPaginate .= "<li class='page-item active'><a class='page-link'>".__('last')."</a></li>";
        }
