...
$statusaction = ($_SESSION['user_type'] == "administrator")?"<div class='btn-group' role='group' aria-label='Edit Button'><a href='javascript:void(0);' class='btn btn-sm btn-danger waves-effect deleteAjax' data-id='$row[id]' data-tbl='customer_access' data-file='0'><i class='fa fa-trash'></i></a></div>":"";
...
while ($row = mysqli_fetch_assoc($empRecords)) {
    $data[] = array(
    		...
    		"mobile"    =>$row['mobile'],
            "status"    =>($row['status'] == 1)?"<span class='badge badge-success'>Verified</span>" : "<span class='badge badge-danger'>Not Verified</span>",
