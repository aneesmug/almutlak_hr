...
/*******************/
	mysqli_query($conDB, "UPDATE `employees` SET `fly`='no' WHERE `emp_id`='".$_GET['emp_id']."' ") or die ();
	mysqli_query($conDB, "UPDATE `apply_vac_dep` SET `review`='C' WHERE `id`='".$_GET['appid']."' AND `emp_id`='".$_GET['emp_id']."' ") or die ();
	mysqli_query($conDB, "UPDATE `emp_vacation` SET `arrived_date`='".$_GET['arrived_date']."', `review`='C' WHERE `id`='".$_GET['arvid']."' AND `emp_id`='".$_GET['emp_id']."' ") or die ();
