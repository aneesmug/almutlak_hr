    ...
    <script>
        ...
        async function loadImage() {
            return new Promise((resolve) => {
                ...
                baseImage.src = "eid-34088913.jpg"; // Replace with your image path
                baseImage.onload = () => {
        ...
        function updateText() {
            ...
            if (text && fontLoaded) {
                ctx.font = "bold 70px 'Almarai'";
                ctx.fillStyle = "#243587";
                ...
                ctx.fillText(text, canvas.width/2, 850); // Adjusted position - moved text down
