...
<div class="row">
	<div class="col-12">
		<div class="card-box table-responsive">
			<h4 class="m-t-0 header-title">Log Activity</h4>
...
//	$datevac = date('d, M Y', $times_reg);
	...
	$timestamp_reg = strtotime("$reg_date");
	$new_date_format = date('d, M Y h:i a', $timestamp_reg);
