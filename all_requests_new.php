...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title><?= $site_title ?> - All Vouchers</title>
...
<table id="smartRequestTbl" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
    ...
    $(document).ready(function(){
        ...
        buttonConfig.push({text: '<i class="fa fa-plus"></i> Add Voucher', action: function ( e, dt, button, config ) { addVoucherFunc(<?=$empid?>) } ,className: 'btn-info'});
            ...
            var table = $('#smartRequestTbl').DataTable({
                ...
                ajax: {
                    type: "POST",
                    url:'./includes/ajaxFile/smartRequestAjaxfile.php',
                    data: function (d) {
