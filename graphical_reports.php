...
$graph_report_types = [
    'employee' => [
        ...
        'columns' => $graph_cols(['name', 'emp_id', 'iqama', 'iqama_exp', 'passport_number', 'passport_exp', 'mobile', 'emg_mobile', 'emg_name', 'email', 'c_email', 'address', 'comp_no', 'dept', 'actual_job', 'emptype', 'salary', 'joining_date', 'contract_expiry', 'ter_date', 'country', 'supervisor_id', 'vacation_days', 'fly', 'bank_name', 'iban', 'dob', 'sex', 'blood_type', 'mar_status', 'gosi', 'emp_sup_type', 'vac_period', 't_shirt_size', 'probation', 'payment_type']),
