...
(() => {
          ...
          a(
            a(
              a(
                a(
                  a(
                    a(a(a((c = {}), g, "Classic"), x, "Duotone"), n, "Sharp"),
                    r,
                    "Sharp Duotone"
                  ),
                  o,
  ...
  (i = p({}, e))[g] = p(p(p(p({}, { "fa-duotone": "duotone" }), e[g]), n), r);
  var ht = u(i),
    gt =
      (((s = p(
        {},
      ...
      ))[g] = p(p(p(p({}, { duotone: "fad" }), s[g]), o), Q)),
      u(s)),
    pt = (((l = p({}, Z))[g] = p(p({}, l[g]), { fak: "fa-kit" })), u(l)),
    bt =
      (((f = p(
        {},
        {
  ...
  function Jt(t, e, n) {
    ...
    "function" != typeof I.hooks.addPack || a
      ? (I.styles[t] = p(p({}, I.styles[t] || {}), r))
      : I.hooks.addPack(t, Yt(e)),
      "fas" === t && Jt("fa", e);
  }
  var Ht,
    Bt = I.styles,
  ...
  function Zt() {
    ...
    (Kt = e.names),
      (Gt = e.unicodes),
      (O = ae(A.styleDefault, { family: A.familyDefault }));
  }
  function te(t, e) {
    return (Xt[t] || {})[e];
  }
  ...
  (Ht = function (t) {
    O = ae(t.styleDefault, { family: A.familyDefault });
  }),
    St.push(Ht),
    Zt();
  var ne = function () {
  ...
  function ue(t) {
    ...
    var e = t.iconName,
      n = t.prefix || O;
    if (e)
      return (e = E(n, e) || e), Lt(de.definitions, n, e) || Lt(I.styles, n, e);
  }
  var de = new n(),
    me = {
      noAuto: function () {
      ...
      dom: {
        ...
        watch: function () {
          ...
          !1 === A.autoReplaceSvg && (A.autoReplaceSvg = !0),
            ...
            Dt(function () {
              he({ autoReplaceSvgRoot: e }), M("watch", t);
            });
        },
      },
      parse: {
        icon: function (t) {
          ...
          return null === t
            ...
            ? ((e = 0 === t[1].indexOf("fa-") ? t[1].slice(3) : t[1]),
              { prefix: (n = ae(t[0])), iconName: E(n, e) || e })
            : "string" == typeof t &&
              (-1 < t.indexOf("".concat(A.cssPrefix, "-")) || t.match(bt))
            ? {
                prefix: (n = ie(t.split(" "), { skipLookups: !0 })).prefix || O,
  ...
  var xe = { found: !1, width: 512, height: 512 };
  function we(o, i) {
    var s = i;
    return (
      ...
      new Promise(function (t, e) {
        ...
        if (
          ("fa" === s &&
            ((n = ee(o) || {}), (o = n.iconName || o), (i = n.prefix || i)),
          o && i && ve[i] && ve[i][o])
        )
          return t(ye(ve[i][o]));
        (a = o),
  ...
  function ke() {}
  function Se(t) {
    Ae.mark("".concat(je, " ").concat(t, " ends")),
      Ae.measure(
        "".concat(je, " ").concat(t),
  ...
  var Ae =
    ...
    Pe = {
      begin: function (t) {
        return (
          Ae.mark("".concat(je, " ").concat(t, " begins")),
          function () {
            return Se(t);
          }
        );
  ...
  var Ee = {
    replace: function (t) {
      ...
      n.parentNode &&
        ...
        null === n.getAttribute(w) && A.keepOriginalSource
          ? ((e = y.createComment(" ".concat(n.outerHTML, " "))),
  ...
  function ze(n, t) {
    ...
    0 === n.length
      ? a()
      : (A.mutateApproach === ct ? v.requestAnimationFrame || Ce : Ce)(
          function () {
            var t =
                (!0 !== A.autoReplaceSvg && Ee[A.autoReplaceSvg]) || Ee.replace,
              e = Pe.begin("mutate");
            n.map(t), e(), a();
          }
        );
  ...
  function Re(t) {
    ...
    U &&
      ...
      ((e = t.treeCallback),
      (o = void 0 === e ? Fe : e),
      (i = void 0 === (e = t.nodeCallback) ? Fe : e),
      (s = void 0 === (e = t.pseudoElementsCallback) ? Fe : e),
      ...
      (i.iconName && i.prefix) ||
        (i.prefix &&
          ...
          (i.iconName =
            ((e = i.prefix),
            (n = t.innerText),
            (qt[e] || {})[n] || te(i.prefix, Wt(t.innerText)))),
        !i.iconName &&
          A.autoFetchSvg &&
          t.firstChild &&
  ...
  var Je = I.styles;
  function He(t) {
    var e = "nest" === A.autoReplaceSvg ? Ye(t, { styleParser: !1 }) : Ye(t);
        ...
        return {
          counter: function (r) {
            var o =
              ...
              t = o.styles,
              f = void 0 === t ? {} : t;
            return ge({ type: "counter", content: r }, function () {
              return (
        ...
        : ((e = F(m.children).filter(function (t) {
          ...
          e && !l
            ...
            : void (!l ||
              ...
              (d = isNaN(d) ? "normal" : d),
              (r = (Ke[u] || {})[d] || Ge[u]),
              (d = Wt(b(n.replace(_e, ""))[0] || "")),
              (u = l[0].startsWith("FontAwesome")),
              (n = (c = f)
                .getPropertyValue("font-feature-settings")
                .includes("ss01")),
              (l = c.getPropertyValue("content").replace(_e, "")),
              (f = (f = l.codePointAt(0)) >= Xe[0] && f <= Xe[1]),
  ...
  (an = { mixoutsTo: me }.mixoutsTo),
          ...
          return {
            ...
            watch: function (t) {
              ...
              rn
                ? Le()
                : Re(
                    ce("mutationObserverCallbacks", { observeMutationsRoot: e })
                  );
            },
          };
        },
    ...
    (function (t) {
      ...
      V &&
        (v.FontAwesome || (v.FontAwesome = me),
        Dt(function () {
          he(), M("bootstrap");
        })),
        (I.hooks = p(
