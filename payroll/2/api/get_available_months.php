...
try {
    // Select distinct month_year values from the generated_payrolls table
    $stmt = $pdo->query("SELECT DISTINCT month_year FROM generated_payrolls ORDER BY month_year DESC");
