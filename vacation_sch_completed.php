                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="alert alert-success bg-success text-white border-0">
									<h1 style="font-family: 'Lemonada', cursive; font-size: 60px;">Thank you.</h1>
                                    <h1 style="font-family: 'Lemonada', cursive; font-size: 30px;">Your information added successfully.</h1>
                                    <?php
										header("refresh:3; https://www.google.com.sa/");
