                ...
                <div class="step-container">
                    ...
                    <div class="screenshot-wrapper">
                        ...
                        <div class="screenshot-gallery">
                            ...
                            <div class="gallery-item">
                                <div class="gallery-item-img"><i class="fa fa-bars"></i></div>
                                <div class="gallery-item-title">More Menu</div>
                            </div>
                            <div class="gallery-item">
                ...
                <div class="step-container">
                    ...
                    <div class="screenshot-wrapper">
                        ...
                        <div class="screenshot-gallery">
                            ...
                            <div class="gallery-item">
                                <div class="gallery-item-img"><i class="fa fa-pencil-alt"></i></div>
                                <div class="gallery-item-title">Enter Reason</div>
                            </div>
                            <div class="gallery-item">
                                <div class="gallery-item-img"><i class="fa fa-paper-plane"></i></div>
                                <div class="gallery-item-title">Submit Request</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="step-container">
                    ...
                    <div class="screenshot-wrapper">
                        ...
                        <div class="screenshot-gallery">
                            ...
                            <div class="gallery-item">
                                <div class="gallery-item-img"><i class="fa fa-calculator"></i></div>
                                <div class="gallery-item-title">Calculate Amount</div>
                            </div>
                            <div class="gallery-item">
                                <div class="gallery-item-img"><i class="fa fa-check"></i></div>
                                <div class="gallery-item-title">Review & Submit</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="step-container">
                    ...
                    <div class="screenshot-wrapper">
                        ...
                        <div class="screenshot-gallery">
                            ...
                            <div class="gallery-item">
                                <div class="gallery-item-img"><i class="fa fa-dollar-sign"></i></div>
                                <div class="gallery-item-title">Amount Details</div>
                            </div>
                            <div class="gallery-item">
                                <div class="gallery-item-img"><i class="fa fa-calendar"></i></div>
                                <div class="gallery-item-title">Installment Plan</div>
                            </div>
                            <div class="gallery-item">
                                <div class="gallery-item-img"><i class="fa fa-file-contract"></i></div>
                                <div class="gallery-item-title">Review Terms</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="step-container">
                    ...
                    <div class="screenshot-wrapper">
                        ...
                        <div class="screenshot-gallery">
                            ...
                            <div class="gallery-item">
                                <div class="gallery-item-img"><i class="fa fa-file-upload"></i></div>
                                <div class="gallery-item-title">Upload Contract</div>
                            </div>
                            <div class="gallery-item">
                                <div class="gallery-item-img"><i class="fa fa-map-marker"></i></div>
                                <div class="gallery-item-title">Property Details</div>
                            </div>
                            <div class="gallery-item">
                                <div class="gallery-item-img"><i class="fa fa-handshake"></i></div>
                                <div class="gallery-item-title">Confirmation</div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="step-container">
                    ...
                    <div class="screenshot-wrapper">
                        ...
                        <div class="screenshot-gallery">
                            ...
                            <div class="gallery-item">
                                <div class="gallery-item-img"><i class="fa fa-input"></i></div>
                                <div class="gallery-item-title">Enter Amount</div>
                            </div>
                            <div class="gallery-item">
                                <div class="gallery-item-img"><i class="fa fa-calendar-alt"></i></div>
                                <div class="gallery-item-title">Repayment Period</div>
                            </div>
                            <div class="gallery-item">
                                <div class="gallery-item-img"><i class="fa fa-paper-plane"></i></div>
                                <div class="gallery-item-title">Submit</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="step-container">
                    ...
                    <div class="screenshot-wrapper">
                        ...
                        <div class="screenshot-gallery">
                            ...
                            <div class="gallery-item">
                                <div class="gallery-item-img"><i class="fa fa-pencil-alt"></i></div>
                                <div class="gallery-item-title">Fill Details</div>
                            </div>
                            <div class="gallery-item">
                                <div class="gallery-item-img"><i class="fa fa-file-upload"></i></div>
                                <div class="gallery-item-title">Upload Documents</div>
                            </div>
                            <div class="gallery-item">
                                <div class="gallery-item-img"><i class="fa fa-clock"></i></div>
                                <div class="gallery-item-title">Track Status</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="step-container" style="background: linear-gradient(135deg, #f3e5f5 0%, #e1f5fe 100%); border-left-color: var(--info);">
                    ...
                    <div class="screenshot-wrapper" style="margin-top: 20px;">
                        ...
                        <div class="screenshot-gallery">
                            ...
                            <div class="gallery-item">
                                <div class="gallery-item-img"><i class="fa fa-calendar-check"></i></div>
                                <div class="gallery-item-title">Confirm Date</div>
                            </div>
                            <div class="gallery-item">
                                <div class="gallery-item-img"><i class="fa fa-paper-plane"></i></div>
                                <div class="gallery-item-title">Submit Request</div>
                            ...
                            <div class="gallery-item">
                                <div class="gallery-item-img"><i class="fa fa-user-check"></i></div>
                                <div class="gallery-item-title">Active Status</div>
                            </div>
                        </div>
                    </div>
                </div>
