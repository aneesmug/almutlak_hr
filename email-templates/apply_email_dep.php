                ...
                <table class="main" width="100%" cellpadding="0" cellspacing="0"
                    ...
                    <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                        <td class="content-wrap aligncenter"
                            style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0;padding: 20px;border: 3px solid #f9bc0b;border-radius: 7px; background-color: #fff;"
...
<!--                                            <a href="#" style="display: block;margin-bottom: 10px;"> <img src="../assets/images/logo.png" height="28" alt="logo"/></a> <br/>-->
                                            ...
                                            <h3><center>Vacation Applying from "$user_dept" Department</center></h3>
                                    </td>
                                </tr>
                                <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
