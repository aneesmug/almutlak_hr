						...
						<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
							...
							<div class="form-row">
								<div class="form-group col-md-6">
									...
									<input type="text" name="maker_name" required placeholder="Enter maker name" class="form-control" id="maker_name">
								</div>
								<div class="form-group col-md-6">
									<label for="model">Model<span class="text-danger">*</span></label>
									<input type="text" name="model" required placeholder="Enter model" class="form-control" id="model">
								</div>
							</div>
							<div class="form-row">
								<div class="form-group col-md-3">
									<label for="made_year" class="col-form-label">Made Year<span class="text-danger">*</span></label>
									<input type="text" name="made_year" placeholder="Enter made year" class="form-control" id="made_year" required>
								</div>
								<div class="form-group col-md-3">
									<label for="plate_no" class="col-form-label">Plate No.<span class="text-danger">*</span></label>
									<input type="text" name="plate_no" placeholder="1234-ABC" class="form-control" id="plate_no" required autocomplete="off" style="text-transform: uppercase !important;" >
								</div>
								<div class="form-group col-md-3">
